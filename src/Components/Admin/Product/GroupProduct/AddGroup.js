...
import {addGroup} from '../../../../API/GroupProductAPI' 
...
function AddGroup ({onClick}) {
  ...
  const onSubmit = (data) => {
      addGroupProduct(data.codeGroup, data.nameGroup, data.status)
  ...
  const addGroupProduct = (code, name, stt) => addGroup({
    codeGroup: code,
    nameGroup: name,
    status: stt,
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-4">
                    <input type="text"
                      ...
                      id="codeGroup"
                      name="codeGroup"
                      {...register("codeGroup", { required: true })}
                    />
                    {errors.codeGroup?.type === 'required' && <p className="errorSignIn">&nbsp; Vui lòng nhập mã nhóm sản phẩm </p>}
                  </div>
                  ...
                  <div className="col-sm-4">
                    ...
                    />
                    {errors.nameGroup?.type === 'required' && <p className="errorSignIn">&nbsp; Vui lòng nhập tên nhóm sản phẩm </p>}
                  </div>
